...
\textprog{loadResources} ist wiederum eine asynchrone Funktion, die ein Callback als Parameter erhält, welches aufgerufen wird, sobald die \textprog{loadResources}-Funktionen aller Spielobjekte fertig ausgeführt wurden. 